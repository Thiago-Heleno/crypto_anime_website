...
export default function Home() {
  ...
  <>
    <Head>
      <title>Crypto Anime</title>
      <link rel="icon" href="/images/favicon.ico" />
    </Head> 
    
    <div className="leading-normal tracking-normal text-indigo-400 m-6 bg-cover bg-fixed" style={{backgroundImage: `url("/images/header.png")`}}>
